...
G2_EXPORT_INCLUDE_MULTI_RECORD_ENTITIES = 0
G2_SEARCH_INCLUDE_RESOLVED = 0
G2_EXPORT_INCLUDE_POSSIBLY_SAME = 1 << bit(1)
G2_SEARCH_INCLUDE_POSSIBLY_SAME = 1 << bit(1)
G2_EXPORT_INCLUDE_POSSIBLY_RELATED = 1 << bit(2)
G2_SEARCH_INCLUDE_POSSIBLY_RELATED = 1 << bit(2)
G2_EXPORT_INCLUDE_NAME_ONLY = 1 << bit(3)
G2_SEARCH_INCLUDE_NAME_ONLY = 1 << bit(3)
G2_EXPORT_INCLUDE_DISCLOSED = 1 << bit(4)
G2_EXPORT_INCLUDE_SINGLE_RECORD_ENTITIES = 1 << bit(5)
G2_ENTITY_INCLUDE_POSSIBLY_SAME_RELATIONS = 1 << bit(6)
G2_ENTITY_INCLUDE_POSSIBLY_RELATED_RELATIONS = 1 << bit(7)
G2_ENTITY_INCLUDE_NAME_ONLY_RELATIONS = 1 << bit(8)
G2_ENTITY_INCLUDE_DISCLOSED_RELATIONS = 1 << bit(9)
G2_ENTITY_INCLUDE_ALL_FEATURES = 1 << bit(10)
G2_ENTITY_INCLUDE_REPRESENTATIVE_FEATURES = 1 << bit(11)
G2_ENTITY_INCLUDE_ENTITY_NAME = 1 << bit(12)
G2_ENTITY_INCLUDE_RECORD_SUMMARY = 1 << bit(13)
G2_ENTITY_INCLUDE_RECORD_DATA = 1 << bit(14)
G2_ENTITY_INCLUDE_RECORD_MATCHING_INFO = 1 << bit(15)
G2_ENTITY_INCLUDE_RECORD_JSON_DATA = 1 << bit(16)
G2_ENTITY_INCLUDE_RECORD_FEATURE_IDS = 1 << bit(18)
G2_ENTITY_INCLUDE_RELATED_ENTITY_NAME = 1 << bit(19)
G2_ENTITY_INCLUDE_RELATED_MATCHING_INFO = 1 << bit(20)
G2_ENTITY_INCLUDE_RELATED_RECORD_SUMMARY = 1 << bit(21)
G2_ENTITY_INCLUDE_RELATED_RECORD_DATA = 1 << bit(22)
G2_ENTITY_OPTION_INCLUDE_INTERNAL_FEATURES = 1 << bit(23)
G2_ENTITY_OPTION_INCLUDE_FEATURE_STATS = 1 << bit(24)
G2_FIND_PATH_PREFER_EXCLUDE = 1 << bit(25)
G2_INCLUDE_FEATURE_SCORES = 1 << bit(26)
G2_SEARCH_INCLUDE_FEATURE_SCORES = 1 << bit(26)
G2_SEARCH_INCLUDE_STATS = 1 << bit(27)
G2_ENTITY_INCLUDE_RECORD_TYPES = 1 << bit(28)
G2_ENTITY_INCLUDE_RELATED_RECORD_TYPES = 1 << bit(29)
G2_FIND_PATH_MATCHING_INFO = 1 << bit(30)
G2_ENTITY_INCLUDE_RECORD_UNMAPPED_DATA = 1 << bit(31)
G2_ENTITY_OPTION_INCLUDE_FEATURE_ELEMENTS = 1 << bit(32)
G2_FIND_NETWORK_MATCHING_INFO = 1 << bit(33)
G2_ENTITY_OPTION_INCLUDE_MATCH_KEY_DETAILS = 1 << bit(34)
G2_SEARCH_INCLUDE_MATCH_KEY_DETAILS = 1 << bit(34)
G2_RETURN_INFO = 1 << bit(63)
