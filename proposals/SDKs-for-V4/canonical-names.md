...
| G2Config_init(moduleName, iniParams, verboseLogging) | initialize(instanceName, settings, verboseLogging) | - | Consider G2Settings object |
...
| G2ConfigMgr_init(moduleName, iniParams, verboseLogging) | initialize(instanceName, settings, verboseLogging) | - | Consider G2Settings object |
...
| G2_init(moduleName, iniParams, verboseLogging) | initialize(instanceName, settings, verboseLogging, configId) | - | `configId` can be `nil`, `None`, `null`. Consider G2Settings object |
...
| G2Product_validateLicenseFile(licenseFilePath, errorBuf, errorBufSize, resizeFunc) | ???  - probabaly drop | | |
