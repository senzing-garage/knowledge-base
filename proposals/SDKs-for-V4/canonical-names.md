...
| G2Diagnostic_init(moduleName, iniParams, verboseLogging) | init(moduleName, iniParams, verboseLogging, initConfigID) | `initConfigID` can be `nil`, `None`, `null` - | |
...
| G2_init(moduleName, iniParams, verboseLogging) | init(moduleName, iniParams, verboseLogging, initConfigID) | - | `initConfigID` can be `nil`, `None`, `null` |
