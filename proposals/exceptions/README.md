...
1. [ ]    2:     // EAS_ERR_INVALID_XML                                                                    "Invalid XML"
1. [ ]    5:     // EAS_ERR_EXCEEDED_MAX_RETRIES                                                           "Exceeded the Maximum Number of Retries Allowed"
1. [ ]    7:     // EAS_ERR_EMPTY_XML_MESSAGE                                                              "Empty XML Message"
1. [ ]    10:    {G2RetryTimeoutExceeded, G2Retryable},             // EAS_ERR_RETRY_TIMEOUT                                                                  "Retry timeout exceeded"
...
1. [ ]    23:    {G2Unrecoverable},                                 // EAS_ERR_CONFLICTING_DATA_SOURCE_VALUES                                                 "Conflicting DATA_SOURCE values '{0}' and '{1}'"
1. [ ]    24:    {G2Unrecoverable},                                 // EAS_ERR_CONFLICTING_RECORD_ID_VALUES                                                   "Conflicting RECORD_ID values '{0}' and '{1}'"
1. [ ]    25:    {G2Unrecoverable},                                 // EAS_ERR_CONFLICTING_LOAD_ID_VALUES                                                     "Conflicting LOAD_ID values '{0}' and '{1}'"
1. [ ]    26:    {G2Unrecoverable},                                 // EAS_ERR_RESERVED_WORD_USED_IN_DOCUMENT                                                 "Inbound data contains a reserved keyword '{0}'"
1. [ ]    27:    {G2NotFound, G2BadUserInput},                      // EAS_ERR_UNKNOWN_DSRC_CODE_VALUE                                                        "Unknown DATA_SOURCE value '{0}'"
...
1. [ ]    33:    {G2NotFound, G2BadUserInput},                      // EAS_ERR_UNKNOWN_DSRC_RECORD_ID                                                         "Unknown record: dsrc[{0}], record[{1}]"
1. [ ]    34:    {G2Configuration, G2Retryable},                    // EAS_ERR_AMBIGUOUS_ENTITY_FTYPE_MISSING                                                 "AMBIGUOUS_ENTITY Feature Type is not configured"
1. [ ]    35:    {G2Configuration, G2Retryable},                    // EAS_ERR_AMBIGUOUS_TIER_FELEM_MISSING                                                   "AMBIGUOUS_TIER Feature Element is not configured"
1. [ ]    36:    {G2Configuration, G2Retryable},                    // EAS_ERR_AMBIGUOUS_FTYPE_ID_FELEM_MISSING                                               "AMBIGUOUS_FTYPE_ID Feature Element is not configured"
1. [ ]    37:    {G2NotFound, G2BadUserInput},                      // EAS_ERR_UNKNOWN_RESOLVED_ENTITY_VALUE                                                  "Unknown resolved entity value '{0}'"
...
1. [ ]    47:    {G2ModuleGeneric, G2Unrecoverable},                // EAS_ERR_SESSION_IS_INVALID                                                             "Session is invalid"
1. [ ]    48:    {G2ModuleNotInitialized, G2Unrecoverable},         // EAS_ERR_G2_NOT_INITIALIZED                                                             "G2 is not initialized"
1. [ ]    49:    {G2ModuleNotInitialized, G2Unrecoverable},         // EAS_ERR_G2AUDIT_NOT_INITIALIZED                                                        "G2Audit is not initialized"
1. [ ]    50:    {G2ModuleNotInitialized, G2Unrecoverable},         // EAS_ERR_G2HASHER_NOT_INITIALIZED                                                       "G2Hasher is not initialized"
1. [ ]    51:    {G2UnacceptableJsonKeyValue, G2BadUserInput},      // EAS_ERR_BOTH_RECORD_ID_AND_ENT_SRC_KEY_SPECIFIED                                       "Cannot use both Record ID and Entity Source Key in record"
1. [ ]    52:    {G2Unrecoverable},                                 // EAS_ERR_UNKNOWN_RELATIONSHIP_ID_VALUE                                                  "Unknown relationship ID value '{0}'"
1. [ ]    53:    {G2Unrecoverable},                                 // EAS_ERR_G2DIAGNOSTIC_NOT_INITIALIZED                                                   "G2Diagnostic is not initialized"
1. [ ]    54:    {G2RepositoryPurged, G2Retryable},                 // EAS_ERR_G2_DATA_REPOSITORY_WAS_PURGED                                                  "Data repository was purged"
...
1. [ ]    61:    {G2Configuration, G2Retryable},                    // EAS_ERR_AMBIGUOUS_SUPPRESSED_LIBFEAT_FELEM_MISSING                                     "AMBIGUOUS_SUPRESSED_LIBFEAT Feature Element is not configured"
1. [ ]    62:    {G2Unrecoverable},                                 // EAS_ERR_AMBIGUOUS_TYPE_FELEM_MISSING                                                   "AMBIGUOUS_TYPE Feature Element is not configured"
1. [ ]    63:    {G2ModuleNotInitialized, G2Unrecoverable},         // EAS_ERR_G2CONFIGMGR_NOT_INITIALIZED                                                    "G2ConfigMgr is not initialized"
1. [ ]    64:    {G2Configuration, G2Retryable},                    // EAS_ERR_CONFUSED_ENTITY_FTYPE_MISSING                                                  "CONFUSED_ENTITY Feature Type is not configured"
...
1. [ ]    999:   {G2ModuleLicense, G2Unrecoverable},                // EAS_ERR_LICENSE_HAS_EXPIRED                                                            "License has expired"
1. [ ]    1000:  {G2Database, G2Unrecoverable},                     // EAS_ERR_UNHANDLED_DATABASE_ERROR                                                       "Unhandled Database Error '{0}'"
1. [ ]    1001:  {G2Unrecoverable},                                 // EAS_ERR_CRITICAL_DATABASE_ERROR                                                        "Critical Database Error '{0}'"
...
1. [ ]    1007:  {G2DatabaseConnectionLost, G2Retryable},           // EAS_ERR_DATABASE_CONNECTION_LOST                                                       "Database Connection Lost '{0}'"
...
1. [ ]    2089:  {G2NotFound, G2BadUserInput},                      // EAS_ERR_UNKNOWN_FCLASS_ID                                                              "UNKNOWN FCLASS ID[{0}]"
...
1. [ ]    2208:  {G2Configuration, G2Retryable},                    // EAS_ERR_DATA_SOURCE_CODE_ALREADY_EXISTS                                                "Data source code [{0}] already exists."
...
1. [ ]    7221:  {G2Configuration, G2Retryable},                    // EAS_ERR_NO_CONFIG_REGISTERED_FOR_DATA_ID                                               "No engine configuration registered with data ID [{0}]."
...
1. [ ]    7344:  {G2NotFound, G2BadUserInput},                      // EAS_ERR_UNKNOWN_MAPPING_DIRECTIVE                                                      "Invalid mapping directive [{0}] for attribute [{1}]."
1. [ ]    7426:  {G2BadUserInput},                                  // EAS_ERR_XLITERATOR_FAILED                                                              "Transliteration failed"
...
1. [ ]    9000:  {G2ModuleLicense, G2Unrecoverable},                // EAS_LIMIT_MAX_OBS_ENT                                                                  "LIMIT: Maximum number of records ingested: {0}"
...
1. [ ]    30110: {G2MessageBuffer, G2Retryable},                    // EAS_ERR_RESPONSE_MESSAGE_SIZE_LARGER_THAN_BUFFER_SIZE                                  "Response message size [{0}] is larger than buffer size [{1}]"
1. [ ]    30111: {G2MessageBuffer, G2Retryable},                    // EAS_ERR_RESPONSE_RESIZE_FUNCTION_IS_NOT_PROVIDED                                       "Resize function is not provided"
1. [ ]    30112: {G2MessageBuffer, G2Retryable},                    // EAS_ERR_RESPONSE_RESIZE_FUNCTION_GAVE_INVALID_RESULT                                   "Resize function returned an invalid result"
1. [ ]    30121: {G2MalformedJson, G2BadUserInput},                 // EAS_ERR_JSON_PARSING_FAILURE                                                           "JSON Parsing Failure [code={0},offset={1}]"
1. [ ]    30122: {G2MalformedJson, G2BadUserInput},                 // EAS_ERR_JSON_PARSING_FAILURE_MUST_BE_OBJECT_OR_ARRAY                                   "JSON Parsing Failure.  JSON must be object or array."
1. [ ]    30123: {G2MalformedJson, G2BadUserInput},                 // EAS_ERR_JSON_PARSING_FAILURE_OBJECT_HAS_DUPLICATE_KEYS                                 "Json object has duplicate keys."
