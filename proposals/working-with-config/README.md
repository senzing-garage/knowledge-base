...
1. **DataSourceList** - (_string_) a list of data source names (format currently undetermined)
...
| setDefaultConfig(configDefinition, configComment) | int64        | Convenience function |
