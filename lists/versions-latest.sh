...
# Generated on 2021-03-26 by https://github.com/Senzing/dockerhub-util dockerhub-util.py version: 1.0.0 update: 2021-02-22
...
export SENZING_DOCKER_IMAGE_VERSION_ENTITY_SEARCH_WEB_APP=2.2.2
...
export SENZING_DOCKER_IMAGE_VERSION_SENZING_API_SERVER=2.5.0
...
export SENZING_DOCKER_IMAGE_VERSION_SSHD=1.1.0
export SENZING_DOCKER_IMAGE_VERSION_STREAM_LOADER=1.7.3
