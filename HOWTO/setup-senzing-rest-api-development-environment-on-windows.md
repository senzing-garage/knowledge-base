...
1. Create `%SENZING_VAR_DIR%/sample-data-project.csv` file with following contents:
    ...
    customer,CSV,/opt/senzing/g2/python/demo/truthset-person-v1-set1.csv
    watchlist,CSV,/opt/senzing/g2/python/demo/truthset-person-v1-set2.csv
    ```
...
1. :pencil2: Identify the IP address of the host system.
   Example:
    ...
    ```console
    set SENZING_DOCKER_HOST_IP_ADDR=10.1.1.100
    ```
